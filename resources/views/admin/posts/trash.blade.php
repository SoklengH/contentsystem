...
<body>
            ...
            <!-- USER INFO - START -->
                <div class="profile-info row">
                    <div class="profile-image col-md-4 col-sm-4 col-xs-4">
                        <a href="#"><img src="images/user/xs/default.png" class='img-responsive img-circle'>
                        </a>
                    </div>
                </div>
    ...
    <div class="container" style="width: 100%" style="position: relative;">
        <div class="row" id="main-content" style="margin-left:15%;">
            <div class="pro-button table-responsive" id="myDIV">
                <a href="{{ route('posts') }}"><button type="button" class="btn btn-success set-botton">Back</button></a>
            </div>
