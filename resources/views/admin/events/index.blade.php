    ...
    <div class="container" style="width: 100%" style="position: relative;">
            <div class="row" id="main-content">
                ...
                <div class="addnewitem">
                    <button type="button" class="btn btn-success" style="height: 40px" "><a href="{{ route('event.create') }}">Add New Events</a></button>
                </div>
                <div class="wrapper">
										    	...
										    	<tbody>
										    		@foreach($events as $event)
										    		 	...
										    		 	<tr>
										    		 		...
										    		 		<td>
																<img src="{{ $event->featured }}" alt="" width="50px" height="50px">
															</td>
															<td>
										    		 			{{ $event->description }}
										    		 		</td>
										    		 		...
										    		 		<td>
										    		 			<a href="{{ route('event.edit', ['id' => $event->id]	) }}" class="btn btn-xs btn-info">
										    		 				{{-- <span class="glypyicon glyphicon-pancil"></span> --}}
										    		 				Edit
										    		 			</a>
										    		 		</td>
										    		 		<td>
										    		 			<a href="{{ route('event.delete', ['id' => $event->id]) }}" class="btn btn-xs btn-danger">
