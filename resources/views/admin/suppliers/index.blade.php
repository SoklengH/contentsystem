    ...
    <div class="container" style="width: 100%" style="position: relative;">
            <div class="row" id="main-content">
                <div class="pro-button table-responsive" id="myDIV">
                    ...
                    <button type="button" class="btn btn-success set-botton""><a href="{{ route('events') }}">Event</button>
                    <button type="button" class="btn active btn-success set-botton""><a href="{{ route('suppliers') }}">Suppliers</button>
                ...
                <div class="addnewitem">
                    <button type="button" class="btn btn-success" style="height: 40px" "><a href="{{ route('supplier.create') }}">Add New Supplier</a></button>
                </div>
                <div class="wrapper">
										    	...
										    	<tbody>
										    		@foreach($suppliers as $supplier)
										    		 	...
										    		 	<tr>
										    		 		...
										    		 		<td>
																<img src="{{ $supplier->featured }}" alt="" width="50px" height="50px">
															</td>
															<td>
										    		 		...
										    		 		<td>
										    		 			<a href="{{ route('supplier.edit', ['id' => $supplier->id]	) }}" class="btn btn-xs btn-info">
										    		 				{{-- <span class="glypyicon glyphicon-pancil"></span> --}}
										    		 				Edit
										    		 			</a>
										    		 		</td>
										    		 		<td>
										    		 			<a href="{{ route('supplier.delete', ['id' => $supplier->id]) }}" class="btn btn-xs btn-danger">
