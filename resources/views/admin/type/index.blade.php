    ...
    <div class="container" style="width: 100%" style="position: relative;">
            <div class="row" id="main-content">
                <div class="pro-button table-responsive" id="myDIV">
                    ...
                    <button type="button" class="btn active btn-success set-botton""><a href="{{ route('type') }}">Categories Type</button>
                </div>

                <hr style="margin-top: 110px;">

                <div class="addnewitem">
                    <button type="button" class="btn btn-success" style="height: 40px" "><a href="{{ route('type.create') }}">Add New CategoryType</a></button>
                </div>
                <div class="wrapper">
