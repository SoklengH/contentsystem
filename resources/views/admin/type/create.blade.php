        ...
        <div class="container" style="width: 100%" style="position: relative;">
            <div class="row" id="main-content" style="margin-right: 200px">
                <div class="panel panel-default">
                    <div class="panel-heading"><h1>Create New Type</h1></div>
                    <div class="panel-body">
                        <form action="{{ route('type.store') }}" method="post">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="type" class="form-control" required autofocus>
                            </div>

                            <div class="form-group">
                                <div class="text-center">
                                    <button class="btn btn-success" type="submit">Store Type</button>
