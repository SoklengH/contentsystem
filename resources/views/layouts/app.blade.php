    ...
    <div class="container" style="width: 100%" style="position: relative;">
            <div class="row" id="main-content">
                {{-- <div class="pro-button">
                    <button type="button" class="btn btn-success" style="padding-right:30px"><a href="{{ route('posts') }}">All Products</a></button>

                    
                    <button type="button" class="btn btn-success" style="padding-right:30px "><a href="{{ route('categories') }}">Categories</a></button>
                    <button type="button" class="btn btn-success" style="padding-right:30px">Success</button>
                </div> --}}
                <div class="wrapper">
